...
#roads_low::outline[zoom>=6][zoom<=8] {
  [zoom=6] {
    [type='motorway'] {
      line-width: 0.6;
      line-color: @roads_low_outline_color;
    }
  }
  [zoom=7] {
    [type='motorway'] {
...
#roads_med[zoom>=9][zoom<=10] {
  ::outline {
    [type='motorway'],
    [type='motorway_link'] {
      line-color: @roads_med_outline_color;
      [zoom=9] {
        line-color: @roads_med_outline_color;
      }
    }
...
*/
  ...
  [zoom>=14] {
    [stylegroup='minorroad'], [stylegroup='track'] { line-opacity: 1.0 }
  }
  [zoom=14] {
  ...
  [zoom>=15] {
    [stylegroup='restricted'], [stylegroup='path'], [stylegroup='cycleway'] { line-opacity: 1.0 }
  }
  [zoom=15] {
