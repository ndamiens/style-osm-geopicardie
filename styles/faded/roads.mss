...
#roads_low::outline[zoom>=6][zoom<=8] {
  [zoom=6] {
    [type='motorway'] {
      line-width: 0.6;
      line-color: lighten(@motorway_line, 13%);
    }
  }
  [zoom=7] {
    [type='motorway'] {
...
#roads_med[zoom>=9][zoom<=10] {
  ::outline {
    [type='motorway'],
    [type='motorway_link'] {
      line-color: lighten(@motorway_line, 0%);
      [zoom=9] {
      	line-color: lighten(@motorway_line, 0%);
      }
    }
    [type='trunk'],
    [type='trunk_link'] {
      line-color: lighten(@trunk_line, 0%);
      [zoom=9] {
      	line-color: lighten(@trunk_line, 0%);
      }
    }
...
#bridge[render='1_outline'][zoom>=11][zoom<=20]{
  ...
  [type='motorway'],
  [type='motorway_link'] {
    line-color: lighten(@motorway_case, 0%);
    [bridge=1] { line-color: lighten(@motorway_case, 0%); }
  }
  [type='trunk'],
  [type='trunk_link'] {
